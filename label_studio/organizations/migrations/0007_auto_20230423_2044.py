# Generated by Django 3.2.16 on 2023-04-23 13:44
...
class Migration(migrations.Migration):
    ...
    def create_groups(apps, schema_migration):
        ...
        full_right.remove(add_organ)
        admin_permission= full_right
        admin_permission.remove(delete_organ)
        ...
        add_annotationdraft = Permission.objects.get(codename='add_annotationdraft')
        change_annotationdraft  = Permission.objects.get(codename='change_annotationdraft')
        delete_annotationdraft  = Permission.objects.get(codename='delete_annotationdraft')
        view_annotationdraft  = Permission.objects.get(codename='view_annotationdraft')
        ...
        annotator_permission = [view_project, add_annotation, change_annotation, delete_annotation, view_annotation,
                                add_annotationdraft, change_annotationdraft, delete_annotationdraft, view_annotationdraft,
    ...
    dependencies = [
        ('organizations', '0006_auto_20230423_1721'),
    ]
